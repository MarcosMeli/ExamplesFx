...
namespace ExamplesFx.Controls
{
        ...
        : ExamplesContainer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.reflectionHeader1.BandDown.Color.Color2 = Color.FromArgb(((int) (((byte) (40)))),
                ((int) (((byte) (40)))),
                ((int) (((byte) (40)))));
            ...
            this.reflectionHeader1.BandUp.Color.Color2 = Color.FromArgb(((int) (((byte) (40)))),
                ((int) (((byte) (40)))),
                ((int) (((byte) (40)))));
            ...
            this.reflectionHeader1.GradientBack.Color1 = Color.FromArgb(((int) (((byte) (0)))),
                ((int) (((byte) (1)))),
                ((int) (((byte) (74)))));
            this.reflectionHeader1.GradientBack.Color2 = Color.FromArgb(((int) (((byte) (5)))),
                ((int) (((byte) (0)))),
                ((int) (((byte) (107)))));
            this.reflectionHeader1.GradientBack.Direction = GradientDirection.Vertical;
            this.reflectionHeader1.Header.Color.Color1 = Color.FromArgb(((int) (((byte) (255)))),
                ((int) (((byte) (255)))),
                ((int) (((byte) (255)))));
            this.reflectionHeader1.Header.Color.Color2 = Color.FromArgb(((int) (((byte) (200)))),
                ((int) (((byte) (200)))),
                ((int) (((byte) (255)))));
            ...
            this.reflectionHeader1.Images.AddRange(new ImageShape[] {
                new ImageShape(((Bitmap) (resources.GetObject("reflectionHeader1.Images"))),
                    true,
                    ((byte) (255)),
                    new Point(3, 1),
                    ((byte) (0)),
            ...
            textShape1.Color.Color1 = Color.FromArgb(((int) (((byte) (255)))),
                ((int) (((byte) (255)))),
                ((int) (((byte) (255)))));
            textShape1.Color.Color2 = Color.FromArgb(((int) (((byte) (200)))),
                ((int) (((byte) (200)))),
                ((int) (((byte) (255)))));
